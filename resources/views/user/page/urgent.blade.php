            ...
            <div class="container">
                ...
                <div class="ad-profile section">	
                   ...
                   <ul class="user-menu">
                        ...
                        <li   class="active"><a href="{{ route('user.urgent.requirement') }}">Urgent requirement</a></li>
                        <li><a href="{{ route('user.complete.donation') }}">Donation Complete</a></li>
                        <li><a href="{{ route('user.pandingDonation')}}">Panding donation</a></li>
                        <li><a href="{{ route('user.favoriateDonation')}}">Favourite Donation</a></li>
...
$(function(){
  ...
  function call_ajax(url,data){
    ...
    call_ajax("{{ URL::route('user.get.urgentRequirement')}}",0);
