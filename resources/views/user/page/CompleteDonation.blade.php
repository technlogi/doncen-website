                ...
                <div class="ad-profile section">	
                    <div class="user-profile">
                        ...
                        <div class="favorites-user">
                            ...
                            <div class="favorites">
                                <a href="#">{{ $total_post }}<small>Post Completed</small></a>
                            </div>
                        </div>								
                    </div><!-- user-profile -->
                    ...
                    <ul class="user-menu">
                        ...
                        <li class="active"><a href="{{ route('user.complete.donation') }}">Complete</a></li>
...
function checks(){
     ...
     var status=true;
        var error_msz='';
            ...
            var title_nod = $('#report');
            
           
             // alert(title_nod.val());
              var desc_nod = $('#report3');
            //  alert(desc_nod.val());
            ...
            if(desc_nod.val().trim().length<5)
            {
                $('#desc_error').show();
                //desc_nod.parent().append('<li class="error-li"> Description must have minimum 5 characters.</li>');
                // error_msz+="<li> Invalid name. Only Alphabates allowed (minimum 3).</li><br>";
                status=false;
            }
