                            ...
                            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-target="#product-carousel" data-slide-to="0" class="active">
                                        <img src="{{ URL::asset('/uploads/images/slider/list-1.jpg')}}" alt="Carousel Thumb" class="img-responsive">
                                    </li>
                                    <li data-target="#product-carousel" data-slide-to="1">
                                        <img src="{{ URL::asset('/uploads/images/slider/list-2.jpg')}}" alt="Carousel Thumb" class="img-responsive">
                                    </li>
                                    <li data-target="#product-carousel" data-slide-to="2">
                                        <img src="{{ URL::asset('/uploads/images/slider/list-3.jpg')}}" alt="Carousel Thumb" class="img-responsive">
                                    </li>
                                    <li data-target="#product-carousel" data-slide-to="3">
                                        <img src="{{ URL::asset('/uploads/images/slider/list-4.jpg')}}" alt="Carousel Thumb" class="img-responsive">
                                    </li>
                                    <li data-target="#product-carousel" data-slide-to="4">
                                        <img src="{{ URL::asset('/uploads/images/slider/list-5.jpg')}}" alt="Carousel Thumb" class="img-responsive">
                                    </li>
                                </ol>
                                ...
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="item active">
                                        <div class="carousel-image">
                                            <!-- image-wrapper -->
                                            <img src="{{ URL::asset('/uploads/images/slider/1.jpg')}}" alt="Featured Image" class="img-responsive">
                                        </div>
                                    </div><!-- item -->
                                    ...
                                    <div class="item">
                                        <div class="carousel-image">
                                            <!-- image-wrapper -->
                                            <img src="{{ URL::asset('/uploads/images/slider/2.jpg')}}" alt="Featured Image" class="img-responsive">
                                        </div>
                                    </div><!-- item -->
                                    ...
                                    <div class="item">
                                        <div class="carousel-image">
                                            <!-- image-wrapper -->
                                            <img src="{{ URL::asset('/uploads/images/slider/3.jpg')}}" alt="Featured Image" class="img-responsive">
                                        </div>
                                    </div><!-- item -->
                                    ...
                                    <div class="item">
                                        <div class="carousel-image">
                                            <!-- image-wrapper -->
                                            <img src="{{ URL::asset('/uploads/images/slider/4.jpg')}}" alt="Featured Image" class="img-responsive">
                                        </div>
                                    </div><!-- item -->
                                    ...
                                    <div class="item">
                                        <div class="carousel-image">
                                            <!-- image-wrapper -->
                                            <img src="{{ URL::asset('/uploads/images/slider/5.jpg')}}" alt="Featured Image" class="img-responsive">
                                        </div>
                                    </div><!-- item -->
                                </div><!-- carousel-inner -->
