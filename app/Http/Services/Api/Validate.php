...

 {
...

    {
        ...
        $validator = Validator::make($request->all(), ['contact' => 'required']);
         ...
         $validator = Validator::make($request->all(), ['contact' => 'regex:/^[0-9]{10}$/']);
            ...
            $validator = Validator::make($request->all(), ['password'=> 'regex:/^\d{4}$/']);
    ...
    */
...

    {
        ...
        $validator = Validator::make($request->all(), ['image_file1'=> 'nullable|image|mimes:jpeg,jpg,png,gif']);
        ...
        if ($validator->fails()) {
                ...
                return [ 'response_code' => 401 ,
                        ...
                        'message'=> "Please select valid image formate image file 1."

                        ];            

        }

        $validator = Validator::make($request->all(), ['image_file2'=> 'nullable|image|mimes:jpeg,jpg,png,gif']);
        ...
        if ($validator->fails()) {
                ...
                return [ 'response_code' => 401 ,
                        ...
                        'message'=> "Please select valid image formate image file 2."

                        ];            

        } 

        $validator = Validator::make($request->all(), ['image_file3'=> 'nullable|image|mimes:jpeg,jpg,png,gif']);
        ...
        if ($validator->fails()) {
                ...
                return [ 'response_code' => 401 ,
                        ...
                        'message'=> "Please select valid image formate image file 3."

                        ];            

        } $validator = Validator::make($request->all(), ['image_file4'=> 'nullable|image|mimes:jpeg,jpg,png,gif']);
        ...
        if ($validator->fails()) {
                ...
                return [ 'response_code' => 401 ,
                        ...
                        'message'=> "Please select valid image formate image file 4."
        ...
        $validator = Validator::make($request->all(), ['d_address'=> 'min:3']);
        ...
        if ($validator->fails()) {
            ...
            return ['response_code'=>401,
                    ...
                    'message'=>  "Doner/Donee Adress must be min 3 character."

                    ];            

        }

        $validator = Validator::make($request->all(), ['d_address'=> 'regex:/[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]{3}/']);
        ...
        if ($validator->fails()) {
            ...
            return ['response_code'=>401,
                    ...
                    'message'=>  "Donor/Donee address should have proper Location, City, State, Country."
        ...
        // $validator = Validator::make($request->all(), ['helper_address'=> 'min:3']);
        ...
        //             'message'=>  "Helper Address must be min 3 character."

        //             ];            

        // }

        $validator = Validator::make($request->all(), ['helper_address'=> 'nullable|regex:/[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]{3}/']);
        ...
        if ($validator->fails()) {
            ...
            return ['response_code'=>401,
                    ...
                    'message'=>  "Helper address should have proper Location, City, State, Country."
        ...
        $validator = Validator::make($request->all(), ['donation_address'=> 'min:3']);
        ...
        if ($validator->fails()) {
            ...
            return ['response_code'=>401,
                    ...
                    'message'=>  "Donation Address must be min 3 character."

                    ];            

        }

        $validator = Validator::make($request->all(), ['donation_address'=> 'regex:/[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]+\,[a-zA-Z0-9 ]{3}/']);
        ...
        if ($validator->fails()) {
            ...
            return ['response_code'=>401,
                    ...
                    'message'=>  "Donation address should have proper Location, City, State, Country."
