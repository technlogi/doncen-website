...
class UserController extends Controller
{
    ...
    // print_r($city_name);
        ...
        // $length = sizeof($city_name);
        // if($length == 1){
        //     $city = \App\Models\City::where('name','LIKE',$city_name[$length - 1])->first();
        // }else if( $length >= 1){
        //     $city = \App\Models\City::where('name','LIKE',$city_name[$length - 2])->first();
        //     if(empty($city))
        //      $city = \App\Models\City::where('name','LIKE','%'.$city_name[$length - 3].'%')->first();
        // }else if ($length == 2){
        //     $city = \App\Models\City::where('name','LIKE','%'.$city_name[0].'%')->first();
        //     if(empty($city))
        //     $city = \App\Models\City::where('name','LIKE','%'.$city_name[1].'%')->first();
        //     if(empty($city))
        //     $city = \App\Models\City::where('name','LIKE','%'.$city_name[2].'%')->first();
        // }else{
